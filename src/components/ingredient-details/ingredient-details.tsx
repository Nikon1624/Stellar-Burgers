...
export const IngredientDetails: React.FC<IngredientDetailsProps> = ({ ingredient }) => {
  return (
    <div className={ classnames(styles.ingredientDetails, 'pl-15 pr-15 pb-5') }>
      ...
      <div className={ styles.ingredientsNutritions }>
        <div className={ classnames(styles.ingredientsNutrition, 'mr-5') }>
          <span className="mb-1">Калории,ккал</span>
          <span className="text text_type_digits-default">
            { ingredient.calories }
          </span>
        </div>
        <div className={ classnames(styles.ingredientsNutrition, 'mr-5') }>
          <span className="mb-1">Белки, г</span>
          <span className="text text_type_digits-default">
            { ingredient.proteins }
          </span>
        </div>
        <div className={ classnames(styles.ingredientsNutrition, 'mr-5') }>
          <span className="mb-1">Жиры, г</span>
          <span className="text text_type_digits-default">
            { ingredient.fat }
          </span>
        </div>
        <div className={ classnames(styles.ingredientsNutrition) }>
          <span className="mb-1">Углеводы, г</span>
          <span className="text text_type_digits-default">
